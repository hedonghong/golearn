...
type JobSchedulePlan struct {
	Job *Job //任务信息
	Expr *cronexpr.Expression //解析好的job的cronexpr表达式
...
func UnpackJob(valye []byte) (job *Job, err error) {
	var jobobj *Job
	jobobj = &Job{}//@todo 是否可以使用pool实现
	if err = json.Unmarshal(valye, jobobj); err != nil {
		return
	}
	job = jobobj
	return
